...
func (t Transform3) toLocal(pointInWorld *Vector3D) *Vector3D {
...
func (t Transform3) toWorld(pointInLocal *Vector3D) *Vector3D {
...
func (t Transform3) toWorldDirection(dirInLocal *Vector3D) *Vector3D {
